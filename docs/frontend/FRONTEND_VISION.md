...
|---|---|---|---|---|
| D — Vinilo girando | ✅ | — (mejoras de detalle) | 🟢 Baja | 🟢 Ninguno |
| B — Puerta de vidrio | ✅ | Marco metálico detallado | 🟢 Baja-media | 🟢 Bajo |
| I — Glitch de error | ✅ | — | 🟢 Baja | 🟢 Ninguno |
...
| F — Escáner láser | — | ✅ | 🟢-🟡 Baja-media | 🟡 Medio (a11y) |
| Puerta abre/cierra (local) | — | ✅ | 🟡 Media | 🟢 Bajo (a11y live regions) |
...
| C — Audio visualizer | — | ✅ | Reacción visual a estado de reproducción (sin acoplar store) |
| F — ProgressBar neón | ✅ (glow + breathe) | Glow "en cola" (`semantic-queue`) | — |
| B — Vinyl Cards | ✅ (hover/tap + sello) | Surcos animados, reflejo | — |
| G — Líneas láser PlayerBar | — | ✅ | — |
| A — Estantes virtuales | — | ✅ | Texturas detalladas |
