#!/usr/bin/env python3
"""Análisis simple sin dependencias externas - usando solo struct"""
...
def read_flac_info(file_path):
    ...
    try:
        with open(file_path, 'rb') as f:
            ...
            # Formato: 1 byte (last/type), 3 bytes (length)
            ...
            min_frame = struct.unpack('>I', b'\x00' + streaminfo[4:7])[0]  # 24 bits
            max_frame = struct.unpack('>I', b'\x00' + streaminfo[7:10])[0]  # 24 bits
            ...
            compression = (1 - bitrate / bitrate_theoretical) * 100 if bitrate_theoretical > 0 else 0
            ...
            return {
                ...
                "bitrate_actual_mbps": bitrate,
                "bitrate_theoretical_mbps": bitrate_theoretical,
                "bitrate_actual_kbps": bitrate * 1000,
